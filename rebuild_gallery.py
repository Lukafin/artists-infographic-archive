...
<head>
  ...
  <style>
    ...
    * {{ box-sizing:border-box; }}
    ...
    .info-panel {{ position:absolute; top:48px; right:0; margin-top:0; width:min(320px, calc(100vw - 56px)); max-width:calc(100vw - 56px); padding:14px; border-radius:18px; background:rgba(255,253,249,.95); border:1px solid rgba(255,255,255,.9); box-shadow:0 16px 38px rgba(0,0,0,.2); backdrop-filter:blur(16px); }}
