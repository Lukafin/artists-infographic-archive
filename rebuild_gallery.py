...
BASE_CSS = """
    ...
    * {{ box-sizing:border-box; }} html {{ scroll-behavior:smooth; }}
    ...
    .science-hero-copy .topic-pills {{ grid-template-columns:repeat(2,minmax(0,220px)); justify-content:start; }} .science-hero-copy .topic-pills > span {{ min-height:56px; padding:10px 14px; border-radius:18px; font-size:14px; line-height:1.2; }}
