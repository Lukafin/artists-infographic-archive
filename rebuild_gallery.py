...
BASE_CSS = """
    ...
    * {{ box-sizing:border-box; }} html {{ scroll-behavior:smooth; }}
    ...
    .hero-image-wrap,.thumb {{ position:absolute; inset:0; display:block; overflow:hidden; text-decoration:none; background:#fffaf0; }} .hero-image-wrap img {{ width:100%; height:100%; display:block; object-fit:cover; object-position:top center; }} .thumb img {{ position:absolute; inset:0; width:100%; height:100%; display:block; object-position:center; }} .thumb-backdrop {{ object-fit:cover; filter:blur(18px) brightness(.62) saturate(.82); transform:scale(1.12); }} .thumb-image {{ z-index:1; object-fit:contain; }} .hero-title-overlay h3 {{ font-size:26px; }}
